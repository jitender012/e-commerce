...
namespace FurnitureShop.Areas.Seller.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        public ActionResult Edit(int id)
        {
            ...
            var product = mapper.Map<EditProductViewModel>(productService.GetProductById(id));
            return View(product);
        }
        ...
        public ActionResult Edit(EditProductViewModel data, HttpPostedFileBase ImageFile)
        {
            if (ModelState.IsValid)
            {
                ...
                var product = mapper.Map<ProductDomainModel>(data);
                var isSuccess = productService.UpdateProduct(product);
                if (isSuccess)
                {
        ...
        {        
            var product = productService.GetProducts(sellerId: User.Identity.GetUserId());          
            return Json(product, JsonRequestBehavior.AllowGet);
        }
        public JsonResult UpdateProductStatus(int pId, bool isActive)
        {
