...
namespace FurnitureShop.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success  :
                    ...
                    {                        
                        return RedirectToAction("Home", "Home", new { area = "Administration" });
                    }
                    else if (UserManager.IsInRole(user.Id, "Seller")){
                        return RedirectToAction("Home", "Home", new { area = "Seller" });
                    }                  
                    else
                    {
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> RegisterSeller(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.Email, Email = model.Email };
